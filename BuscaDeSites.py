...
class SiteInvestigator:
    def __init__(self):
        ...
        self.results = {}
        self.timeout = 10  # Timeout padrão para todas as operações de rede
  ...
  """ + Fore.YELLOW + "  Ferramenta de Investigação Digital" + Style.RESET_ALL)
    ...
    def get_dns_records(self, domain):
        ...
        resolver.timeout = 5  # Timeout fixo de 5 segundos
        resolver.lifetime = 5
        ...
        try:
            ...
            for name, func, arg, key in checks:
                try:
                    ...
                    # Adiciona geolocalização para IPs
    ...
    def display_results(self):
        ...
        if self.results['ip_addresses']:
            for ip in self.results['ip_addresses']:
                ...
                # Mostra geolocalização se disponível
