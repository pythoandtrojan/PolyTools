...
class Banners:
    ...
    def git_exposed():
        ...
        01000110 01001001 01001110 01000100 01001001 01001110 01000111 00100000 01010011 01000101 01000011 01010010 01000101 01010100 01010011 00100000 01001001 01001110 00100000 01000111 01001001 01010100
        01011001 01001111 01010101 01010010 00100000 01010011 01000101 01000011 01010010 01000101 01010100 01010011 00100000 01000001 01010010 01000101 00100000 01001110 01001111 01010100 00100000 01010011 01000001 01000110 01000101
        """
    ...
    def xss():
        ...
        01010100 01001000 01000101 00100000 01010111 01000101 01000010 00100000 01001001 01010011 00100000 01010110 01010101 01001100 01001110 01000101 01010010 01000001 01000010 01001100 01000101
        """
        
    @staticmethod
    def zero_day():
        return """
        01011010 01000101 01010010 01001111 00100000 01000100 01000001 01011001 00100000 01000101 01011000 01010000 01001100 01001111 01001001 01010100 01010011
        ...
        01010100 01001000 01000101 00100000 01010000 01001111 01010111 01000101 01010010 00100000 01010100 01001111 00100000 01000010 01010010 01000101 01000001 01001011 00100000 01000001 01001110 01011001 01010100 01001000 01001001 01001110 01000111
        """
...
class HackerMenu:
    def __init__(self):
        self.tools = {
            ...
            "scanner": {
                ...
                "git-scanner.py": "Scanner de repositórios Git expostos"
            },
            "brute": {
            ...
            "git-exposto": {
                "git-scanner.py": "Scanner de repositórios Git expostos",
                "git-exploit.py": "Exploração de repositórios Git"
            },
            "xss": {
                "xss.py": "Ferramenta de testes XSS",
                "xss-exploit.py": "Exploração de vulnerabilidades XSS"
            },
            "zero-day": {
                "zero-day.py": "Exploits de dia zero",
                "exploit-finder.py": "Localizador de vulnerabilidades não corrigidas"
            }
        }
    ...
    def authenticate(self):
        ...
        for attempt in range(max_attempts):
            password = getpass.getpass("[bold red]Enter Password: [/bold red]")
            if password == "admin123":
                return True
            console.print(f"[bold red]Incorrect password! Attempts remaining: {max_attempts - attempt - 1}[/bold red]")
        return False
    ...
    def show_main_menu(self):
        ...
        table.add_row("8", "GIT EXPOSED", "Scanner de repositórios Git")
        table.add_row("9", "XSS", "Ferramentas de ataque XSS")
        table.add_row("10", "ZERO-DAY", "Exploits de dia zero")
    ...
    def show_category_menu(self, category):
        while True:
            ...
            elif category == "git-exposed":
                console.print(Panel.fit(Banners.git_exposed(), style="bold blue"))
            elif category == "xss":
                console.print(Panel.fit(Banners.xss(), style="bold yellow"))
            elif category == "zero-day":
                console.print(Panel.fit(Banners.zero_day(), style="bold red"))
    ...
    def run_tool(self, category, tool_name):
        ...
        try:
            ...
            elif tool_name.endswith('.html'):
                webbrowser.open(f'file://{os.path.abspath(script_path)}')
                console.print("[bold green]Página HTML aberta no navegador padrão[/bold green]")
                console.input("\nPressione Enter para continuar...")
                return
            else:
    ...
    def run(self):
        if not self.authenticate():
            console.print("[bold red]Acesso negado! Saindo...[/bold red]")
            time.sleep(2)
            sys.exit(1)
        ...
        while True:
            ...
            if choice == "1":
                ...
                self.show_category_menu("git-exposed")
            elif choice == "9":
