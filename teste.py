...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠛⠛⠿⠿⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠿⠿⠟⠛⠋⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
     ...
     v 9.8.9 data: 19/11/2025                  ass:  | made: Brasil⠀⠀⠀⠀
                             desde: 10/7/2025⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀               
        [/bold red]"""
...
class HackerMenu:
    def __init__(self):
        ...
        self.tools = {
            ...
            "ferramentas": {
                "Mr.Holmes.py": "Ferramenta de análise forense digital",
    ...
    def show_main_menu(self):
        ...
        table.add_row("5", "VUL-WEB", "Vulnerabilidades Web (XSS, SQLi)")
        table.add_row("6", "SPAN", "Ferramentas de envio em massa")
        table.add_row("7", "PHISHING", "Ferramentas de engenharia social")
        table.add_row("8", "FERRAMENTAS", "Ferramentas diversas e utilitários")
        table.add_row("9", "DoS", "Ataques de Denial of Service")
        table.add_row("10", "DOX", "Ferramentas de coleta de informações pessoais")
        table.add_row("11", "TESTE-REDE", "Ferramentas de teste de rede")
        table.add_row("12", "LINUX", "Ferramentas para distribuições Linux")
        table.add_row("13", "VPN", "Ferramentas de VPN")
        table.add_row("14", "WI-FI", "Ferramentas de análise Wi-Fi")
        table.add_row("15", "BLUETOOTH", "Ferramentas de Bluetooth")
        table.add_row("16", "EXTRAS", "Ferramentas adicionais")
