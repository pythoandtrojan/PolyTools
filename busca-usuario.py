...
def verificar_site(site, username):
    ...
    try:
        ...
        if resposta.status_code == 200:
            # Verificações para evitar falsos positivos
            if site == "GitHub":
                ...
                # Verificação genérica para outros sites
                exists = True
...
def buscar_perfis(username):
    ...
    # Usando ThreadPool para verificar vários sites simultaneamente
...
# Lista completa de sites (100 no total) organizados por categorias
sites = {
    # Redes Sociais (20)
    "GitHub": {
